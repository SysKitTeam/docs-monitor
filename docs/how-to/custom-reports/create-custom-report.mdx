...
Download the definition of this custom report:

<DownloadButton 
  href="/monitor/assets/Idle-Activities-Today.zip"
  filename="Idle-Activities-Today.zip"
  fileSize="2.1 KB"
  fileType="ZIP"
  description="Custom report definition for idle activities tracking"
/>
