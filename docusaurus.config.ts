...
const config: Config = {
  ...
  // For deployment on /monitor route
  baseUrl: '/monitor/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'Syskit', // Usually your GitHub org/user name.
  projectName: 'Syskit Monitor', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          //editUrl:
            //'https://github.com/SysKitTeam/docs-monitor',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://www.syskit.com/products/monitor/',
          label: 'Product Site',
          position: 'right',
        },
      ],
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: 'https://github.com/SysKitTeam/docs-monitor.git',
            },
          ],
        },
      ],
