...
* A new column „**State**“ was added to the Client IP Addresses and Targets report to make it easier to distinct if the user has been idle or active at the specified time frame during his session. 
